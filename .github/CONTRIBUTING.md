...
3. After you submit your pull request, verify that all [status
   ...
   status checks are failing?</summary>If a status check is failing, and you
   believe that the failure is unrelated to your change, please leave a comment
   on the pull request explaining why you believe the failure is unrelated. I'll
   re-run the status check for you. If I can conclude that the failure was a
   false positive, then I'll open an issue to track that problem with our status
   check suite.</details>
...
[don't ask questions in a issue thread]:
  https://Jarvim.atom.io/2016/04/19/managing-the-deluge-of-atom-issues.html
